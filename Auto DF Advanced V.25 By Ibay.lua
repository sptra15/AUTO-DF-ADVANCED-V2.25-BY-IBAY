...
{
    "sub_name": "Auto DF Settings",
    "icon": "Verified",
    "menu": [
        {
            "type": "input_string",
            "text": "World Name (World Farming)",
            "default": "nameworld",
            "alias": "nameworld"
        },
        {
            "type": "input_string",
            "text": "World Save Seed",
            "default": "worldsave|DoorID",
            "alias": "worldsaveseed"
        },
        {
            "type": "input_string",
            "text": "Storage Platform",
            "default": "worldstorage|DoorID",
            "alias": "StoragePlat"
        },
        {
            "type": "button",
            "text": "Start Script",
            "alias": "startScript",
            "callback": "runMainScript"
        }
    ]
}
]]
addIntoModule(settingsModule)

-- Ambil nilai dari module dan simpan default kalau kosong
local nameworld = alias_nameworld or "nameworld"
local worldsaveseed = alias_worldsaveseed or "worldsave|DoorID"
local StoragePlat = alias_StoragePlat or "worldstorage|DoorID"

-- ===== Fungsi untuk save settings otomatis =====
function saveSettings()
    alias_nameworld = nameworld
    alias_worldsaveseed = worldsaveseed
    alias_StoragePlat = StoragePlat
    saveModule()  -- GrowLauncher menyimpan module secara otomatis
end


-- Jalankan save saat module diubah
function OnModuleChange()
    nameworld = alias_nameworld or nameworld
    worldsaveseed = alias_worldsaveseed or worldsaveseed
    StoragePlat = alias_StoragePlat or StoragePlat
    saveSettings()
end

-- ===== Fungsi utama =====
function runMainScript()
    saveSettings()  -- pastikan setting tersimpan sebelum mulai
    sendDialog({
        title = "🚀 Script Pabrik By IBAY 🚀",
        message = "Script dimulai dengan settings:\nWorld: " .. nameworld .. "\nWorld Save Seed: " .. worldsaveseed .. "\nStorage: " .. StoragePlat,
        confirm = "Oke Gas!",
        alias = "IBAY"
    })

    -- Contoh panggil fungsi utama
    AvoidError(mainDF)
end
